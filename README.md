...
- **Academic integrity is enforced in the system prompt itself** ([`src/lib/tutor.ts`](./src/lib/tutor.ts)) — the AI is architecturally forbidden from completing an assignment, and always cites its source.
